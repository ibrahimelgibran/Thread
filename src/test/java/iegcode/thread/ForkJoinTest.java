...
public class ForkJoinTest {
    ...
    void recursiveAction() throws InterruptedException {
        ...
        List<Integer> integers = IntStream.range(0, 30).boxed().collect(Collectors.toList());
    ...
    void recursiveTask() throws InterruptedException, ExecutionException {
        ...
        ForkJoinTask<Long> sumbit = pool.submit(task);

        Long aLong = sumbit.get();
        System.out.println(aLong);

        // CEK Manual apakah sama total sumnya
